...
class Shipments extends React.Component {
  ...
  shipmentSelected = (id) => {
    store.selectShipment(id, (nextShipment) => {
      //browserHistory.push('/shipments/'+id);
  ...
  render() {
    ...
    return (
      <Page title="Envios" icon="content_copy" toggleDrawer={this.props.toggleDrawer} search="/search">
        <Inbox>
          <InboxList>
